                             ...
                             <div className="overflow-x-auto border border-light-border dark:border-dark-border rounded-lg max-h-[50vh]">
                                <table className="w-full text-sm text-left">
                                    ...
                                    <tbody className="text-gray-700 dark:text-gray-300">
                                        {/* FIX: Correctly sort numeric values by destructuring in the sort callback to aid type inference. */}
                                        {/* FIX: Explicitly cast counts to numbers to resolve TypeScript inference issue in sort callback. */}
                                        {Object.entries(rawCategoryCounts).sort(([, countA], [, countB]) => (countB as number) - (countA as number)).map(([rawCategory, count]) => (
                             ...
                             <div className="overflow-x-auto border border-light-border dark:border-dark-border rounded-lg max-h-[50vh]">
                                <table className="w-full text-sm text-left">
                                    ...
                                    <tbody className="text-gray-700 dark:text-gray-300">
                                        {/* FIX: Correctly sort numeric values by destructuring in the sort callback to aid type inference. */}
                                        {/* FIX: Explicitly cast counts to numbers to resolve TypeScript inference issue in sort callback. */}
                                        {Object.entries(rawPriorityCounts).sort(([, countA], [, countB]) => (countB as number) - (countA as number)).map(([rawPriority, count]) => (
